...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/users/sanskrj/deeporange14_control/src/ros_canopen/canopen_motor_node/include;/usr/include".split(';') if "/users/sanskrj/deeporange14_control/src/ros_canopen/canopen_motor_node/include;/usr/include" != "" else []
