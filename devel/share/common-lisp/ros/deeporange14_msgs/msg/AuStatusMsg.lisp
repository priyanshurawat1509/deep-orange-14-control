...
(cl:ensure-generic-function 'timesecLog-val :lambda-list '(m))
(cl:defmethod timesecLog-val ((m <AuStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deeporange14_msgs-msg:timesecLog-val is deprecated.  Use deeporange14_msgs-msg:timesecLog instead.")
  (timesecLog m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AuStatusMsg>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'timesecRtk))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'timesecLog))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AuStatusMsg>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'timesecLog) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AuStatusMsg>)))
  ...
  "b6d8c735ac8cf63f71026c5a7809db64")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AuStatusMsg)))
  "Returns md5sum for a message object of type 'AuStatusMsg"
  "b6d8c735ac8cf63f71026c5a7809db64")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AuStatusMsg>))
  ...
  (cl:list 'AuStatusMsg
    ...
    (cl:cons ':timesecLog (timesecLog msg))
))
