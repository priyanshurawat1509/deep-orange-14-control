...
class MobilityMsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.brkL_cmd, buffer, bufferOffset);
    // Serialize message field [brkR_cmd]
    bufferOffset = _serializer.float32(obj.brkR_cmd, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.brkL_cmd = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [brkR_cmd]
    data.brkR_cmd = _deserializer.float32(buffer, bufferOffset);
