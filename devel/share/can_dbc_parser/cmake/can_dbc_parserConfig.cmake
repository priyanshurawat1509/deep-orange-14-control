...
if("TRUE" STREQUAL "TRUE")
  set(can_dbc_parser_SOURCE_PREFIX /home/sanskrj/deeporange14_control/src/raptor-dbw-ros/can_dbc_parser)
  set(can_dbc_parser_DEVEL_PREFIX /home/sanskrj/deeporange14_control/devel)
  ...
  set(can_dbc_parser_INSTALL_PREFIX /home/sanskrj/deeporange14_control/install)
...
if(NOT "/home/sanskrj/deeporange14_control/src/raptor-dbw-ros/can_dbc_parser/include " STREQUAL " ")
  set(can_dbc_parser_INCLUDE_DIRS "")
  set(_include_dirs "/home/sanskrj/deeporange14_control/src/raptor-dbw-ros/can_dbc_parser/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'can_dbc_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sanskrj/deeporange14_control/src/raptor-dbw-ros/can_dbc_parser/${idir}'.  ${_report}")
    endif()
