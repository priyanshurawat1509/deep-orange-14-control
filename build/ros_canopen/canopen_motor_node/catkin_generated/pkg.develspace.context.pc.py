...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/users/vpurohi/deeporange_ws/deeporange14_control/src/ros_canopen/canopen_motor_node/include;/usr/include".split(';') if "/users/vpurohi/deeporange_ws/deeporange14_control/src/ros_canopen/canopen_motor_node/include;/usr/include" != "" else []
