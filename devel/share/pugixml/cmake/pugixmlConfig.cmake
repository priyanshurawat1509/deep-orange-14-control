...
if("TRUE" STREQUAL "TRUE")
  set(pugixml_SOURCE_PREFIX /home/administrator/Documents/DEEPORANGE14/deeporange14_control/src/pugixml)
  set(pugixml_DEVEL_PREFIX /home/administrator/Documents/DEEPORANGE14/deeporange14_control/devel)
  set(pugixml_INSTALL_PREFIX "")
  set(pugixml_PREFIX ${pugixml_DEVEL_PREFIX})
else()
  set(pugixml_SOURCE_PREFIX "")
  set(pugixml_DEVEL_PREFIX "")
  set(pugixml_INSTALL_PREFIX /home/administrator/Documents/DEEPORANGE14/deeporange14_control/install)
...
if(NOT "/home/administrator/Documents/DEEPORANGE14/deeporange14_control/src/pugixml/src/include " STREQUAL " ")
  set(pugixml_INCLUDE_DIRS "")
  set(_include_dirs "/home/administrator/Documents/DEEPORANGE14/deeporange14_control/src/pugixml/src/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pugixml' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/administrator/Documents/DEEPORANGE14/deeporange14_control/src/pugixml/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pugixml_EXPORTED_TARGETS ${${pugixml_dep}_EXPORTED_TARGETS})
endforeach()
