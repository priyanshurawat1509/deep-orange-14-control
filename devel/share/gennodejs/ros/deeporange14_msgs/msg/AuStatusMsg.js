...
class AuStatusMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('timesecLog')) {
        this.timesecLog = initObj.timesecLog
      }
      else {
        this.timesecLog = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [timesecLog]
    bufferOffset = _serializer.float64(obj.timesecLog, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [timesecLog]
    data.timesecLog = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'b6d8c735ac8cf63f71026c5a7809db64';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.timesecLog !== undefined) {
      resolved.timesecLog = msg.timesecLog;
    }
    else {
      resolved.timesecLog = 0.0
    }
